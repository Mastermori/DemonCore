...
function getClientOptions(): LanguageClientOptions {
    return {
        ...
        outputChannelName: "DemonassLanguageServer",
        synchronize: {
...
export function activate(context: ExtensionContext) {
    ...
    const pythonPath = path.format(path.parse(workspace
        .getConfiguration("demonass")
        .get<string>("pythonPath") as string));
    ...
    if (context.extensionMode === ExtensionMode.Development) {
        ...
        // client = startLangServer(pythonPath, ["-m", "lsp_server"], cwd);
    ...
    console.error('Congratulations, your extension "demonass" is now active!');
}
